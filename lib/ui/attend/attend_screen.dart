...
class _AttendScreenState extends State<AttendScreen> {
      ...
      body: SingleChildScrollView(
        child: Card(
          ...
          child: Column(
            ...
            children: [
              _buildHeader(),
              _buildCapturePhotoSection(size),
  ...
  Widget _buildCapturePhotoSection(Size size) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Padding(
              ...
              child: SizedBox.expand(
                child: FittedBox(
                  child: image != null
                      ...
                      : Icon(Icons.camera_enhance_outlined, color: Colors.grey.shade800),
                ),
              ),
            ),
          ),
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.grey.shade800)),
          ...
          child: SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.grey.shade800)),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text("Please complete the form", style: TextStyle(color: Colors.white))
                      ],
                    ),
